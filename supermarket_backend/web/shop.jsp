                      ...
                      <div class="header__bottom-left d-flex d-xl-block align-items-center">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="index1.jsp">Home <i class="far fa-angle-down"></i></a>
                                        <ul class="megamenu-1">
                                            <li><a href="index1.jsp">Home Pages</a>
                                                <ul class="mega-item">
                                                    <li><a href="index1.jsp">Home One</a></li>
                                    ...
                                    <li><a href="about.jsp">About Us</a></li>
                                    <li class="has-mega"><a href="shop.jsp" class="active">Shop <i class="far fa-angle-down"></i></a>
                                        <div class="mega-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="product-details.jsp">Product Details</a></li>
                                            <li><a href="faq.jsp">Faq Pages</a></li>
                            ...
                            <div class="product__sm mt-20">
                                <ul>
                                    <li class="product__sm-item d-flex align-items-center">
                                        ...
                                        <div class="product__sm-content">
                                            <h5 class="product__sm-title">
                                                <a href="product-details.jsp">Classic Leather Backpack Daypack 2022</a>
                                            </h5>
                                    ...
                                    <li class="product__sm-item d-flex align-items-center">
                                        ...
                                        <div class="product__sm-content">
                                            <h5 class="product__sm-title">
                                                <a href="product-details.jsp">Samsung Galaxy A12, 32GB, Black - (Locked)</a>
                                            </h5>
                                            <div class="product__sm-price">
                                    ...
                                    <li class="product__sm-item d-flex align-items-center">
                                        ...
                                        <div class="product__sm-content">
                                            <h5 class="product__sm-title">
                                                <a href="product-details.jsp">Imported Wooden Felt Cushion Chair</a>
                                            </h5>
                                            <div class="product__sm-price">
                                    ...
                                    <li class="product__sm-item d-flex align-items-center">
                                        ...
                                        <div class="product__sm-content">
                                            <h5 class="product__sm-title">
                                                <a href="product-details.jsp">Sunhouse Decorative Lights - Imported</a>
                                            </h5>
                                            <div class="product__sm-price">
                        ...
                        <div class="shop-banner mb-30">
                            <div class="banner-image">
                                ...
                                <div class="banner-content text-center">
                                    ...
                                    <a href="shop.jsp" class="st-btn-d b-radius">Discover now</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Casentino Bucket Hat Luxury Goods – Imported</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Classic Leather Backpack Daypack 2022</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Coffee Maker AH240a Full Function</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Imported Wooden Felt Cushion Chair</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Sunhouse Decorative Lights – Imported</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Korea Stainless Steel Pot Set 5 Piecs</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">HP Stainless Steel Hot Water Bottle</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">The North Face Womens Resolve 2 Jack</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Diesel J Ross Rev Reversy Bomber Jacket</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">HOT – H&M “Spring Icons” Collaboration Jackets</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Taffy Candy Laff Bites Net 4.2 oz</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item product__item-d">
                                                ...
                                                <div class="product__content-3">
                                                    <h6><a href="product-details.jsp">Vinh Long Fresh Mangosteen 500g</a></h6>
                                                    <div class="rating mb-5">
                                                        <ul>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                            <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-1.jpg" alt=""></a>
                                                                </div>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-2.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-3.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-4.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-5.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product__offer">
                                                                    <span class="discount">-15%</span>
                                                                </div>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-6.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-7.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                                ...
                                                <div class="single-features-item single-features-item-df b-radius mb-20">
                                                    <div class="row  g-0 align-items-center">
                                                        <div class="col-md-4">
                                                            <div class="features-thum">
                                                                <div class="features-product-image w-img">
                                                                    <a href="product-details.jsp"><img src="assets/img/product/sm-8.jpg" alt=""></a>
                                                                </div>
                                                                <div class="product-action">
                                                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                                        <i class="fal fa-eye"></i>
                                ...
                                <div class="col-xl-12">
                                    <div class="basic-pagination pt-30 pb-30">
                                        <nav>
                                           <ul>
                                              <li>
                                                 <a href="shop.jsp" class="active">1</a>
                                              </li>
                                              <li>
                                                 <a href="shop.jsp">2</a>
                                              </li>
