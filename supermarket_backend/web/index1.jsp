                            ...
                            <div class="header-inner-end text-md-end">
                                <div class="ovic-menu-wrapper">
                                    <ul>
                                        ...
                                        <li><a href="contact.jsp">Order Tracking</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index1.jsp" class="logo-image"><img src="assets/img/logo/logo1.svg" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-8 col-sm-8">
                            <div class="header-action">
                                <div class="block-userlink">
                                    <a class="icon-link" href="my-account.jsp">
                                ...
                                <div class="block-wishlist action">
                                    <a class="icon-link" href="wishlist.jsp">
                                ...
                                <div class="block-cart action">
                                    <a class="icon-link" href="cart.jsp">
                                    ...
                                    <div class="cart">
                                        <div class="cart__mini">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="cart.jsp" class="wc-cart mb-10">View cart</a>
                                                    <a href="checkout.jsp" class="wc-checkout">Checkout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="cat-toggle">
                                ...
                                <div class="cat__menu">
                                    <nav id="mobile-menu" style="display: block;">
                                        <ul>
                                            <li>
                                                <a href="shop.jsp">All Categories <i class="far fa-angle-down"></i></a>
                                                <ul class="mega-menu">
                                                    <li><a href="shop.jsp">Shop Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="product-details.jsp">Standard SHop Page</a></li>
                                                            <li><a href="product-details.jsp">Shop Right Sidebar</a></li>
                                                            <li><a href="product-details.jsp">Shop Left Sidebar</a></li>
                                                            <li><a href="product-details.jsp">Shop 3 Column</a></li>
                                                            <li><a href="product-details.jsp">Shop 4 Column</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop.jsp">Product Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="product-details.jsp">Product Details</a></li>
                                                            <li><a href="product-details.jsp">Product V2</a></li>
                                                            <li><a href="product-details.jsp">Product V3</a></li>
                                                            <li><a href="product-details.jsp">Varriable Product</a></li>
                                                            <li><a href="product-details.jsp">External Product</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop.jsp">Other Pages</a>
                                                        <ul class="mega-item">
                                                            <li><a href="product-details.jsp">wishlist</a></li>
                                                            <li><a href="product-details.jsp">Shopping Cart</a></li>
                                                            <li><a href="product-details.jsp">Checkout</a></li>
                                                            <li><a href="product-details.jsp">Login</a></li>
                                                            <li><a href="product-details.jsp">Register</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop.jsp">Phone &amp; Tablets</a>
                                                        <ul class="mega-item">
                                                            <li><a href="product-details.jsp">Catagory 1</a></li>
                                                            <li><a href="product-details.jsp">Catagory 2</a></li>
                                                            <li><a href="product-details.jsp">Catagory 3</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop.jsp">Phone &amp; Tablets</a>
                                                        <ul class="mega-item">
                                            ...
                                            <li>
                                                <a href="shop.jsp">Phone and Electronics <i class="far fa-angle-down"></i></a>
                                            ...
                                            <li>
                                                <a href="shop.jsp">Best Seller Products
                                            ...
                                            <li>
                                                <a href="shop.jsp">Top 10 Offers
                                                    <span class="cat-label green">new!</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="shop.jsp">New Arrivals <i class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="shop.jsp">Home Appliances</a></li>
                                                    <li><a href="shop.jsp">Technology</a>
                                                        <ul class="submenu">
                                                            <li><a href="shop.jsp">Storage Devices</a></li>
                                                            <li><a href="shop.jsp">Monitors</a></li>
                                                            <li><a href="shop.jsp">Laptops</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop.jsp">Office Equipments</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="shop.jsp">TV &amp; Audio</a></li>
                                            <li><a href="shop.jsp">Electronics &amp; Digital</a></li>
                                            <li class="d-laptop-none"><a href="shop.jsp">Fashion &amp; Clothings</a></li>
                                            <li class="d-laptop-none"><a href="shop.jsp">Jewelry &amp; Watches</a></li>
                                            <li><a href="shop.jsp">Health &amp; Beauty</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                      ...
                      <div class="header__bottom-left d-flex d-xl-block align-items-center">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="index1.jsp" class="active">Home <i class="far fa-angle-down"></i></a>
                                        <ul class="megamenu-1">
                                            <li><a href="index1.jsp">Home Pages</a>
                                                <ul class="mega-item">
                                                    <li><a href="index1.jsp" class="active">Home One</a></li>
                                            ...
                                            <li><a href="shop.jsp">Phone &amp; Tablets</a>
                                                <ul class="mega-item">
                                                    ...
                                                    <li><a href="product-details.jsp">Catagory 2</a></li>
                                                    <li><a href="product-details.jsp">Catagory 3</a></li>
                                                    <li><a href="product-details.jsp">Catagory 4</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="shop.jsp">Phone &amp; Tablets</a>
                                                <ul class="mega-item">
                                    ...
                                    <li><a href="about.jsp">About Us</a></li>
                                    <li class="has-mega"><a href="shop.jsp">Shop <i class="far fa-angle-down"></i></a>
                                        <div class="mega-menu">
                                            <div class="container container-mega">
                                                <ul>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="shop.jsp">SHOP LAYOUT</a></li>
                                                        <li><a href="shop.jsp">Pagination</a></li>
                                                        <li><a href="shop.jsp">Ajax Load More</a></li>
                                                        <li><a href="shop.jsp">Infinite Scroll</a></li>
                                                        <li><a href="shop.jsp">Sidebar Right</a></li>
                                                        <li><a href="shop.jsp">Sidebar Left</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="shop.jsp">SHOP PAGES</a></li>
                                                        <li><a href="shop.jsp">List View</a></li>
                                                        <li><a href="shop.jsp">Small Products</a></li>
                                                        <li><a href="shop.jsp">Large Products</a></li>
                                                        <li><a href="shop.jsp">Shop — 3 Items</a></li>
                                                        <li><a href="shop.jsp">Shop — 4 Items</a></li>
                                                        <li><a href="shop.jsp">Shop — 5 Items</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="shop.jsp">PRODUCT LAYOUT</a></li>
                                                        <li><a href="shop.jsp">Description Sticky</a></li>
                                                        <li><a href="shop.jsp">Product Carousel</a></li>
                                                        <li><a href="shop.jsp">Gallery Modern</a></li>
                                                        <li><a href="shop.jsp">Thumbnail Left</a></li>
                                                        <li><a href="shop.jsp">Thumbnail Right</a></li>
                                                        <li><a href="shop.jsp">Thumbnail Botttom</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                                        <li class="title"><a href="shop.jsp">Basketball</a></li>
                                                        <li><a href="shop.jsp">East Hampton Fleece</a></li>
                                                        <li><a href="shop.jsp">Faxon Canvas Low</a></li>
                                                        <li><a href="shop.jsp">Habitasse Dictumst</a></li>
                                                        <li><a href="shop.jsp">Kaoreet Lobortis</a></li>
                                                        <li><a href="shop.jsp">NikeCourt Zoom</a></li>
                                                        <li><a href="shop.jsp">NikeCourts Air Zoom</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <ul>
                                    ...
                                    <li><a href="blog.jsp">Blog <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="about.jsp">Pages <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            <li><a href="my-account.jsp">My Account</a></li>
                                            <li><a href="product-details.jsp">Product Details</a></li>
                                            <li><a href="faq.jsp">FAQs pages</a></li>
                                ...
                                <div class="col-xl-5">
                                    <div class="slider-content">
                                        <div class="slider-top-btn" data-animation="fadeInLeft" data-delay="1.5s">
                                            <a href="product-details.jsp" class="st-btn b-radius">HOT DEALS</a>
                                        </div>
                                        ...
                                        <div class="slider-bottom-btn mt-75">
                                            <a data-animation="fadeInUp" data-delay="1.15s" href="shop.jsp" class="st-btn-b b-radius">Discover now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="slider-content">
                                        <div class="slider-top-btn" data-animation="fadeInLeft" data-delay="1s">
                                            <a href="product-details.jsp" class="st-btn b-radius">New Arraivels</a>
                                        </div>
                                        ...
                                        <div class="slider-bottom-btn mt-75">
                                            <a data-animation="fadeInUp" data-delay="1.9s" href="shop.jsp" class="st-btn-b b-radius">Discover now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="slider-content">
                                        <div class="slider-top-btn" data-animation="fadeInLeft" data-delay="1s">
                                            <a href="product-details.jsp" class="st-btn b-radius">New DEALS</a>
                                        </div>
                                        ...
                                        <div class="slider-bottom-btn mt-75">
                                            <a data-animation="fadeInUp" data-delay="1.10s" href="shop.jsp" class="st-btn-b b-radius">Discover now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner__item p-relative w-img mb-30">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-1.jpg" alt=""></a>
                            </div>
                            <div class="banner__content">
                                <h6><a href="product-details.jsp">Intelligent <br> New Touch Control</a></h6>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-2.jpg" alt=""></a>
                            </div>
                            <div class="banner__content">
                                <h6><a href="product-details.jsp">On-sale <br> Best Prices</a></h6>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-3.jpg" alt=""></a>
                            </div>
                            <div class="banner__content">
                                <h6><a href="product-details.jsp">Hot Sale <br> Super Laptops 2022 </a></h6>
                            ...
                            <div class="swiper-wrapper">
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Epple iPad Pro 10.5-inch Cellular 64G</a></h6>
                                ...
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Men Size Yellow Basketball Jerseys</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Xbox Wireless Game Controller Pink</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Wireless Bluetooth Over-Ear Headphones</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Solo3 Wireless On-Ear Headphones</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="product__item swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Vifa Bluetooth Portable Wireless Speaker</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="banner__item p-relative w-img mb-30">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-4.jpg" alt=""></a>
                            </div>
                            <div class="banner__content">
                                <span>Bestseller Products</span>
                                <h6><a href="product-details.jsp">PC & Docking Station</a></h6>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-5.jpg" alt=""></a>
                            </div>
                            <div class="banner__content">
                                <span>Featured Products</span>
                                <h6><a href="product-details.jsp">Accessories iPhone</a></h6>
                    ...
                    <div class="col-xl-12">
                        <div class="section__head d-flex justify-content-between mb-30">
                            ...
                            <div class="button-wrap">
                                <a href="shop.jsp">See All Product <i class="fal fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row  g-0 align-items-center">
                                <div class="col-md-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="product-details.jsp"><img src="assets/img/features-product/fpb-1.jpg" alt=""></a>
                                        </div>
                                        <div class="product__offer">
                                            <span class="discount">-15%</span>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="product__content product__content-d">
                                        <h6><a href="product-details.jsp">Samsang Galaxy A70 128GB Dual-SIM</a></h6>
                                        <div class="rating mb-5">
                                            <ul class="rating-d">
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                        ...
                                        <div class="features-des mb-25">
                                            <ul>
                                                <li><a href="product-details.jsp"><i class="fas fa-circle"></i> Bass and Stereo Sound.</a></li>
                                                <li><a href="product-details.jsp"><i class="fas fa-circle"></i> Display with 3088 x 1440 pixels resolution.</a></li>
                                                <li><a href="product-details.jsp"><i class="fas fa-circle"></i> Memory, Storage &amp; SIM: 12GB RAM, 256GB.</a></li>
                                                <li><a href="product-details.jsp"><i class="fas fa-circle"></i> Androi v10.0 Operating system.</a></li>
                                            </ul>
                                        </div>
                                        <div class="cart-option">
                                            <a href="cart.jsp" class="cart-btn-2 w-100 mr-10">Add to Cart</a>
                                            <a href="cart.jsp" class="transperant-btn"><i class="fal fa-heart"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single-features-item b-radius mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.jsp"><img src="assets/img/features-product/fp-1.jpg" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                                    <span class="discount">-15%</span>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="product__content product__content-d">
                                                <h6><a href="product-details.jsp">Epple Watch SE Gold Aluminum</a></h6>
                                                <div class="rating mb-5">
                                                    <ul>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="single-features-item b-radius mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.jsp"><img src="assets/img/features-product/fp-2.jpg" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                        ...
                                        <div class="col-6">
                                            <div class="product__content product__content-d">
                                                <h6><a href="product-details.jsp">G951s Pink Stereo Gaming Headset</a></h6>
                                                <div class="rating mb-5">
                                                    <ul>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="single-features-item b-radius mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.jsp"><img src="assets/img/features-product/fp-3.jpg" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                ...
                                <div class="single-features-item b-radius mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.jsp"><img src="assets/img/features-product/fp-4.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="product__content product__content-d">
                                                <h6><a href="product-details.jsp">Men’s Short-Sleeve Pocket Oxford Shirt</a></h6>
                                                <div class="rating mb-5">
                                                    <ul>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                        <li><a href="#"><i class="fal fa-star"></i></a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="banner__item p-relative w-img mb-30">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-6.jpg" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-sd text-center">
                                <div class="banner-button mb-20">
                                    <a href="product-details.jsp" class="st-btn">HOT DEALS</a>
                                </div>
                                <h6><a href="product-details.jsp">Sale 30% Off <br> Top Computer Case Gaming</a></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="banner__item p-relative mb-30 w-img">
                                    <div class="banner__img">
                                        <a href="product-details.jsp"><img src="assets/img/banner/banner-7.jpg" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-sd text-center">
                                        <h6><a href="product-details.jsp">Electronic Deals</a></h6>
                                        <p>Laptop, Computer, Smartphone, Gampad</p>
                                        <div class="banner-button mt-20 d-none d-sm-block">
                                            <a href="product-details.jsp" class="st-btn-3 b-radius">Shop Deals</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img">
                                        <a href="product-details.jsp"><img src="assets/img/banner/banner-8.jpg" alt=""></a>
                                    </div>
                                    <div class="banner__content">
                                        <h6><a href="product-details.jsp">Hot Products <br> Laptop Ultra 4K 16”</a></h6>
                                        <p>Discount  20% On Products</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img">
                                <a href="product-details.jsp"><img src="assets/img/banner/banner-9.jpg" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-sd text-center">
                                <div class="banner-button mb-20">
                                    <a href="product-details.jsp" class="st-btn">HOT DEALS</a>
                                </div>
                                <h6><a href="product-details.jsp">Sport Edition <br> Best Choice of The Year</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="product-slider-3 swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="product__item mb-20 swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">APPO R11s 64GB Dual 20MP Cameras</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                ...
                                <div class="product__item mb-20 swiper-slide">
                                    ...
                                    <div class="product__content">
                                        <h6><a href="product-details.jsp">Epple iPhone 11 Pro Max 64GB Gold</a></h6>
                                        <div class="rating mb-5">
                                            <ul>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                        ...
                        <div class="product__modal-inner">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product__modal-content">
                                    <h4><a href="product-details.jsp">Samsung C49J89: £875, Debenhams Plus</a></h4>
                                    ...
                                    <div class="footer__widget">
                                        ...
                                        <div class="footer__widget-content">
                                            <div class="footer__link">
                                                <ul>
                                                    <li><a href="faq.jsp">New Customers</a></li>
                                                    <li><a href="faq.jsp">How to use Account</a></li>
                                                    <li><a href="faq.jsp">Placing an Order</a></li>
                                                    <li><a href="faq.jsp">Payment Methods</a></li>
                                                    <li><a href="faq.jsp">Delivery &amp; Dispatch</a></li>
                                                    <li><a href="faq.jsp">Problems with Order</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="footer__widget-content">
                                            <div class="footer__link">
                                                <ul>
                                                    ...
                                                    <li><a href="faq.jsp">Contact Us</a></li>
                                                    <li><a href="faq.jsp">Report Abuse</a></li>
                                                    <li><a href="faq.jsp">Submit a Dispute</a></li>
                                                    <li><a href="faq.jsp">Policies &amp; Rules</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                                <div class="footer__widget">
                                                    ...
                                                    <div class="footer__widget-content">
                                                        <div class="footer__link">
                                                            <ul>
                                                                <li><a href="faq.jsp">Product Support</a></li>
                                                                <li><a href="checkout.jsp">Checkout</a></li>
                                                                <li><a href="cart.jsp">Shopping Cart</a></li>
                                                                <li><a href="wishlist.jsp">Wishlist</a></li>
                                                                <li><a href="faq.jsp">Terms &amp; Conditions &amp;</a></li>
                                                                <li><a href="faq.jsp">Redeem Voucher</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="footer__widget">
                                        ...
                                        <div class="footer__widget-content">
                                            <div class="footer__link">
                                                <ul>
                                                    <li><a href="contact.jsp">Store Location</a></li>
                                                    <li><a href="my-account.jsp">My account</a></li>
                                                    <li><a href="contact.jsp">Order Tracking</a></li>
                                                    <li><a href="faq.jsp">FAQs</a></li>
                                                </ul>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="footer__links text-center mb-25">
                                    <p>
                                        <a href="faq.jsp">Online Shopping</a>
                                        <a href="faq.jsp">Promotions</a>
                                        <a href="faq.jsp">My Orders</a>
                                        <a href="faq.jsp">Help</a>
                                        <a href="faq.jsp">Customer Service</a>
                                        <a href="faq.jsp">Support</a>
                                        <a href="faq.jsp">Most Populars</a>
                                        <a href="faq.jsp">New Arrivals</a>
                                        <a href="faq.jsp">Special Products </a>
                                        <a href="faq.jsp">Manufacturers</a>
                                        <br>
                                        <a href="faq.jsp">Garden Equipments</a>
                                        <a href="faq.jsp">Powers And Hand Tools </a>
                                        <a href="faq.jsp">Utensil &amp; Gadget </a>
                                        <a href="faq.jsp">Printers</a>
                                        <a href="faq.jsp">Projectors</a>
                                        <a href="faq.jsp">Scanners</a>
                                        <a href="faq.jsp">Store</a>
                                        <a href="faq.jsp">Business</a>
                                    </p>
                                </div>
                                <div class="payment-image text-center mb-25">
                                    <a href="contact.jsp"><img src="assets/img/payment/payment.png" alt=""></a>
                                </div>
