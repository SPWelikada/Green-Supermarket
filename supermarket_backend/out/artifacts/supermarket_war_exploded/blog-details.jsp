                                ...
                                <ul>
                                    ...
                                    <li><a href="blog.jsp" class="active">Blog <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="blog-details.jsp" class="active">Blog Details</a></li>
                                        </ul>
                                    </li>
                                    <li>
                  ...
                  <div class="col-xl-8 col-lg-8">
                    <div class="news-detalis-content mb-50">
                        <ul class="blog-meta mb-20">
                           <li><a href="blog-details.jsp"><i class="fal fa-eye"></i>100 Views</a></li>
                           <li><a href="blog-details.jsp"><i class="fal fa-comments"></i> 30 Comments</a></li>
                           <li><a href="blog-details.jsp"><i class="fal fa-calendar-alt"></i> 24th March 2021</a></li>
                        </ul>
                        ...
                        <div class="news-navigation pt-50 pb-40">
                           <div class="changes-info">
                              <span><a href="blog-details.jsp">Prev Post</a></span>
                              <h6 class="changes-info-title"><a href="blog-details.jsp">Tips On Minimalist</a></h6>
                           </div>
                           <div class="changes-info text-md-right">
                              <span><a href="blog-details.jsp">Next Post</a></span>
                              <h6 class="changes-info-title"><a href="blog-details.jsp">Less Is More</a></h6>
                           </div>
                        </div>
