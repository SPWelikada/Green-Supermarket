                    ...
                    <div class="col-lg-6">
                        <div class="basic-login">
                            ...
                            <form action="<%= request.getContextPath()%>/signin" method="post">
                                <label for="users">Username<span>*</span></label>
                                <input id="users" name="username" type="text" placeholder="Enter Username">
                                ...
                                <button type="submit" class="tp-in-btn w-100">SignIn</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="basic-login">
                            ...
                            <form action="<%= request.getContextPath()%>/customer" method="post">
                                ...
                                <input id="contact" name="contact" type="tel" placeholder="Enter contact">
