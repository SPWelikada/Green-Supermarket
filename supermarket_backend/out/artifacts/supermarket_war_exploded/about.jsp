                    ...
                    <div class="col-xl-12">
                        <div class="page-banner-content text-center">
                            ...
                            <div class="page-bottom-btn mt-55">
                                <a href="shop.jsp" class="st-btn-4">Discover now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team text-center mb-30">
                            ...
                            <div class="tauthor-degination mb-15">
                                <h5><a href="about.jsp">Iqbal Hossain</a></h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team text-center mb-30">
                            ...
                            <div class="tauthor-degination mb-15">
                                <h5><a href="about.jsp">Robin Gomes</a></h5>
                                <span>CEO & Pounder</span>
                            </div>
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team text-center mb-30">
                            ...
                            <div class="tauthor-degination mb-15">
                                <h5><a href="about.jsp">Merry Bob</a></h5>
                                <span>CEO & Pounder</span>
                            </div>
                            <div class="team-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
